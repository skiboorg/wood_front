    ...
    <header :class="is_index ? 'text-white' : 'text-black'" class=" relative z-10">
      <div class="hidden md:flex items-center justify-between py-6">
        ...
        <div class="flex gap-2 items-center">
          <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.25 8.25L15.5 1.5L8.75 15.75L7.25 9.75L1.25 8.25Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>

          <p class="mr-4">Москва</p>
      ...
      <div class="flex items-center justify-between gap-4 py-3 md:py-0">
        ...
        <nuxt-link class="hidden md:block" to="/catalog">
          <Button class="!px-6 !py-2" rounded  label="Каталог" />
        </nuxt-link>
        <div class="hidden md:block">
          <a href="tel:+7 495 008 88-81" target="_blank" class="p-button p-component p-button-secondary p-button-rounded !px-6 !py-2 !text-black">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
